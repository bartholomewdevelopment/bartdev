...
export const Portfolio = () => {
  return (
    <div className="w-[95%] md:w-[90%] xl:w-[1200px] mx-auto overflow-hidden">
      ...
      <SectionTitle
        badge="PORTFOLIO"
        title="Cutting-Edge Digital Innovations"
        description="Explore Overtime AM and FARMS, our key software developments. Overtime AM streamlines athletic 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div 
          ...
          className="min-h-[450px] bg-white rounded-lg p-6 flex flex-col justify-between"
        >
          <img 
            className="shadow-md border border-gray-200 rounded-lg w-full h-[250px]" 
            src={img2} 
            alt="Overtime AM" 
          />
          <div className="py-4 flex flex-col flex-grow">
            <h2 className="text-xl font-nexa-bold text-[#FE6A61] mb-3">
        ...
        >
          ...
          <div className="py-4 flex flex-col flex-grow">
            <h2 className="text-xl font-nexa-bold text-[#FE6A61] mb-3">
              FARMS: Farm & Ranch Management System
            </h2>
            <p className="text-lg md:text-xl leading-relaxed text-gray-700 flex-grow">
